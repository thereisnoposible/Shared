#pragma once
#include "proto/protoFiles/command.txt.pb.h"
#include "json/json.h"
                        ...
                        for (int32 j = 0; j < repeatedCount; ++j)
                        {
                            ...
                            switch (pField->type())
                            {
                                ...
                                case ::google::protobuf::FieldDescriptor::TYPE_DOUBLE:
                                {
                                    if (val.isNumeric())
                                    {
                                        pReflection->SetRepeatedDouble(pMessage, pField, j, val.asDouble());
                                    }
                                }break;
                                case ::google::protobuf::FieldDescriptor::TYPE_FLOAT:
                                {
                                    if (val.isNumeric())
                                    {
                                        pReflection->SetRepeatedFloat(pMessage, pField, j, val.asFloat());
                                    }
                                }break;
                                case ::google::protobuf::FieldDescriptor::TYPE_INT32:
                                {
                                    if (val.isInt())
                                    {
                                        pReflection->SetRepeatedInt32(pMessage, pField, j, val.asInt());
                                    }
                                }break;
                                case ::google::protobuf::FieldDescriptor::TYPE_INT64:
                                {
                                    if (val.isInt64())
                                    {
                                        pReflection->SetRepeatedInt64(pMessage, pField, j, val.asInt());
                                    }
                                }break;
                                case ::google::protobuf::FieldDescriptor::TYPE_UINT32:
                                {
                                    if (val.isUInt())
                                    {
                                        pReflection->SetRepeatedUInt32(pMessage, pField, j, val.asUInt());
                                    }
                                }break;
                                case ::google::protobuf::FieldDescriptor::TYPE_UINT64:
                                {
                                    if (val.isUInt64())
                                    {
                                        pReflection->SetRepeatedUInt64(pMessage, pField, j, val.asUInt64());
                                    }
                                }break;
                                case ::google::protobuf::FieldDescriptor::TYPE_STRING:
                                {
                                    if (val.isString())
                                    {
                                        pReflection->SetRepeatedString(pMessage, pField, j, val.asString());
                                    }
                                }break;
                                default:
                                    break;
...
template<>
class JsonConvertImpl<xstring >
{
public:
    static void SerializeProtoBuf(const xstring& val, Json::Value& json)
    {
        json = val;
    }

    static void DeserializeProtoBuf(Json::Value& json, xstring& val)
    {
        val = json.asString();
    }
};
...
public:
    ...
    //ProtoBuf转化到json字符串
    template<typename _Type>
    static xstring ProtoBufToJsonString(const _Type& val)
    {
        Json::Value json;
    ...
    //json字符串 转化到ProtoBuf
    template<typename _Type>
    static void JsonStringToProtoBuf(const xstring& str, _Type& val)
    {
        Json::Reader reader;
        Json::Value json;
