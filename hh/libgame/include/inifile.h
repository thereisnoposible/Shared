...
XClass std::ostream& operator<<(std::ostream& output, CIniFileA& obj);
XClass std::istream& operator>>(std::istream& input, CIniFileA& obj);
XClass std::istream& operator>>(std::istream& input, CIniMergeA merger);
...
XClass std::wostream& operator<<(std::wostream& output, CIniFileW& obj);
XClass std::wistream& operator>>(std::wistream& input, CIniFileW& obj);
XClass std::wistream& operator>>(std::wistream& input, CIniMergeW merger);
