...
struct XClass HTTPRequest
{
	...
	, strRelative("/")
	{
		...
		m_headMap[HTTP_HEAD_CONTENT_TYPE] = "application/x-www-form-urlencoded";
	}
...
typedef xvector<HTTPClientPtr> HTTPClientCollect;