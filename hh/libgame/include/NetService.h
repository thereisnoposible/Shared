...
#define ADD_MSG(_MsgName) NetService::AddNetMsgMapping(_MsgName, #_MsgName);
...
public:
	...
	*/
    ...
    static void AddNetMsgMapping(int32 msgID, const char* msgStr);

    static const char* GetNetMsgMapping(int32 msgID);
protected:
	/**
	* @brief		接收连接
	* @return		void
...
private:
    ...
    static xmap<int32, xstring> s_msgMapping;
};
